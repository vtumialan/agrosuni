                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 bg-white border-b border-gray-200">
                        <div className="flex items-center justify-between mb-6">
                            <Link className="px-6 py-2 text-white bg-blue-500 rounded-md focus:outline-none" :href="route('providers.index')">
                                Volver
                            </Link>
                        </div>
                        <form name="createForm" @submit.prevent="submit">
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                                <div className="mx-4 mb-4">
                                    <BreezeLabel for="name" value="Nombre de Proveedor" />
                                    <BreezeInput
                                        id="name"
                                        type="text"
                                ...
                                <div className="mx-4 mb-4">
                                    <BreezeLabel for="document_id" value="RUC" />
                                    <BreezeInput
                                        id="document_id"
                                        type="text"
                                        class="mt-1 block w-full"
                                        ...
                                        autofocus />
                                    <span className="text-red-600" v-if="form.errors.document_id">
